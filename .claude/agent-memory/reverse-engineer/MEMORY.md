...
- [makeindata-subsystem](makeindata_subsystem.md) — MAKE.INDATA ($1E00, 13877b) one-shot builder: hi-res decompressor + the ART_* artwork + likely the world map. SCOUTED round 24; decompose next (clone gen_gen at BASE=$1E00, port the decompressor)
